"""Recording a meeting straight into the queue.

This is the one thing the desktop window does better than the browser: the web
page needs a secure context before it may touch a microphone, which on a
server means a tunnel or a certificate, while here it is a button.
