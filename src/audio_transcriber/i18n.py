...
MESSAGES = {
    "en": {
        ...
        "gui.row_summary_title": "Summary: {title}",
        ...
        "gui.engine_only": "{engine} would run it",
        "gui.engine_missing": "no transcription engine installed",
    ...
    "it": {
        ...
        "gui.row_summary_title": "Riassunto: {title}",
        ...
        "gui.tab_output": "Risultato",
        "gui.tab_options": "Trascrizione",
        ...
        "gui.engine_only": "{engine} la eseguirebbe",
        "gui.engine_missing": "nessun motore di trascrizione installato",
        "gui.row_machine": "Hardware",
